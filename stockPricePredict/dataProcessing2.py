...
example_path="./data_set/data_set_2017.xlsx"
wb1=openpyxl.load_workbook(example_path)
ws1=wb1['Sheet1']        #ws1用来添加样本数据集

stock_price_2015=pd.read_excel("./stock_price/stock_price_2017.xlsx",sheetname=None,header=None)
stock_price_2015=stock_price_2015['Sheet2']
stock_price_2015=pd.DataFrame(stock_price_2015)
#print(stock_price_2015)

stock_price_2016=pd.read_excel("./stock_price/stock_price_2018.xlsx",sheetname=None,header=None)
stock_price_2016=stock_price_2016['Sheet2']
stock_price_2016=pd.DataFrame(stock_price_2016)


basic_financial_statement=pd.read_excel("./financial_statement/basic_financial_statement_2017.xlsx",sheetname=None,header=None)
...
dealed_financial_statement=pd.read_excel("./financial_statement/dealed_financial_statement_2017.xlsx",sheetname=None,header=None)
...
present_time='2017-09-30'
time='2017-12-31'
final_time='2018-03-31'
for i in range(100):
    value=[]
    j=i*5+4
    ...
    value.append(1-dealed_financial_statement.iloc[88,j])            #21股东权益比率
    ...
    sum_stock_price = 0
    count = 0
    shape=stock_price_2016.shape
    for index in range(4,shape[0]):
        if str(stock_price_2016.iloc[index, 0])>time and str(stock_price_2016.iloc[index, 0])<=final_time:
            sum_stock_price += stock_price_2016.iloc[index, i + 1]
            count += 1.0
